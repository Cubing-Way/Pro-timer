...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-ZU7PSGX4.js
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-MXUQ4IZZ.js")).getPuzzleDescriptionString(config.puzzle);
