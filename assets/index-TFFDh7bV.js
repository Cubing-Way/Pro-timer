...
document.getElementById("secondary-background").addEventListener("change", () => {
  ...
  const bgMain3 = getThemeVar(`theme-${secondaryBackground}`, "--bg-tertiary");
  document.documentElement.style.setProperty("--bg-tertiary", bgMain3);
});
...
document.getElementById("buttons-background").addEventListener("change", () => {
  ...
  const bgMain3 = getThemeVar(`theme-${buttonsBackground}`, "--border-main");
  document.documentElement.style.setProperty("--border-main", bgMain3);
});
